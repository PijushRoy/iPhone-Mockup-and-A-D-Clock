setInterval(() => {
    ...
    document.getElementById("digital-hr").innerHTML = hours
    document.getElementById("digital-min").innerHTML = minutes
    document.getElementById("digital-sec").innerHTML = second
